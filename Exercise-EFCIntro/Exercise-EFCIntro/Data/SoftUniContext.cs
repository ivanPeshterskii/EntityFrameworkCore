...
namespace Exercise_EFCIntro.Data
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<VJobAndSalary> VJobAndSalaries { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost,1433;Database=SoftUni;User Id=sa;Password=YourStrongPassword123!;TrustServerCertificate=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeesWithSalaryOver30000>(entity =>
            {
                ...
                entity.ToTable("EmployeesWithSalaryOver30000");
            ...
            modelBuilder.Entity<VJobAndSalary>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_JobAndSalary");
